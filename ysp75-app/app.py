...
# -------------------------------
# תפריט צד (sidebar) - עיצוב וסידור מודגש
st.sidebar.header("בחר מצב:")
mode = st.sidebar.radio(
    "",
    ("חיפוש שחקנים", "היסטוריית חיפושים"),
    index=0,
    key="mode_select"
)
...
st.sidebar.markdown(
    ...
    "<span style='font-size: 18px; font-weight: bold;'>🔎 חיפוש מתקדם</span><br>"
    "להפעלת חיפוש מתקדם, עבור אל "
    "<a href='https://fstarv-search-7ctjt8skkag7jd9aq6vicm.streamlit.app/' target='_blank' style='color:#2869d9;font-weight:bold;text-decoration:underline;'>"
    "חלון חיפוש מתקדם"
    "</a>"
    "</div>",
