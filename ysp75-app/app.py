...
def run_player_search():
    # כאן שים את קוד חיפוש השחקנים הרגיל שלך כמו שהיה לך!
...
# זה הקישור החדש לחיפוש המתקדם
st.sidebar.markdown("---")
st.sidebar.markdown("🔎 לחיפוש מתקדם עבור אל [חלון חיפוש מתקדם](https://fstarv-search-7ctjt8skkag7jd9aq6vicm.streamlit.app/)")
